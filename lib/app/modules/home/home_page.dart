...
class _HomePageState extends ModularState<HomePage, HomeController> {
  ...
  Widget build(BuildContext context) {
      ...
      body: Observer(
        builder: (_){
          ...
          return ListView.builder(
            ...
            return ItemTile(model: model,onTap: (){
              _showDialog(model);
            });
          });
        },
    ...
    _showDialog([TodoModel model]){
       model ??= TodoModel(); //Se for nulo inicia uma nova instancia
    showDialog(
      context: context,
      builder: (_){
        return AlertDialog(
          title: Text(model.title.isNotEmpty ? 'Edição' : 'Novo'),
          ...
          actions: <Widget>[
            ...
            child: Text(model.title.isEmpty ? 'Adicionar' : 'Salvar'),
            )
          ],
        );
      }
